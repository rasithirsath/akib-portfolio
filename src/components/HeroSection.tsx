  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-navy-200/20 to-navy-400/10 rounded-full blur-3xl animate-float"
          ...
          <div className="text-left">
            ...
            >
              <p className="text-xl text-slate-600 mb-8 leading-relaxed max-w-lg">
                Transforming enterprises through strategic consulting,
                innovative solutions, and proven methodologies that drive
                sustainable growth.
              </p>
            </div>
            ...
            >
              <a
                href="#" // Replace with the actual path to your PDF
                download="My_Resume.pdf" // Optional: This sets the filename
              >
