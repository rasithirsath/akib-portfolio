        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-slate-300 leading-relaxed max-w-md">
              Transforming businesses through strategic insight, innovative solutions, 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-slate-300 hover:text-gold-400 transition-colors duration-300">
                  Home
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-2 text-slate-300">
              ...
              <p>contact@excellence-consulting.com</p>
              <p>+1 (555) 123-4567</p>
            </div>
